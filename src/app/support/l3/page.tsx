...
import { GitBranch, Database, Server, Shield, Clock, FileCode, Network, Bug, Cpu } from "lucide-react";
...
const severityConfig: Record<string, { label: string; color: string; bg: string }> = {
  ...
  P4: { label: "P4 — Low", color: "#6e6e73", bg: "#6e6e7315" },
};
...
const statusLabels: Record<string, { label: string; status: "online" | "warning" | "offline" | "pending" | "maintenance" }> = {
  ...
  resolved: { label: "Resolved", status: "online" },
};
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <MetricCard
          title="Known Issues"
          value="5"
          subtitle="Tracked in knowledge base"
        ...
        <div className="space-y-4">
          <div className="card p-5">
            ...
            <div className="space-y-2">
              {[
                { label: "Infrastructure Monitor", desc: "Real-time AP, switch, and server health", icon: <Network size={16} />, color: "#007aff" },
                { label: "Log Aggregator", desc: "Cross-device log correlation and search", icon: <FileCode size={16} />, color: "#34c759" },
                { label: "Configuration Audit", desc: "Compare device configs against baseline", icon: <GitBranch size={16} />, color: "#ff9500" },
                { label: "Security Scanner", desc: "Vulnerability scan across fleet", icon: <Shield size={16} />, color: "#ff3b30" },
                { label: "Performance Profiler", desc: "CPU, memory, and network profiling", icon: <Cpu size={16} />, color: "#af52de" },
